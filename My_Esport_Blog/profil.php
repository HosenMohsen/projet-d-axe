            ...
            while($message = $r->fetch(PDO::FETCH_ASSOC)){
                ...
                if(isset($_SESSION['id_utilisateur'])){
                  ...
                  if( $_SESSION['pseudo'] == $message['pseudo']){
                    ...
                    echo "<a id='Btn_oui' class='btn btn-secondary' href='profil.php?idtweet=". $message['id_tweet'] ."'>"."  OUI </a>".  "<br>";
                    echo "<a id='Btn_non' class='btn btn-secondary' href='profil.php?pseudo=".$_SESSION["pseudo"] ."'>"."  NON </a>".  "<br>";
                  echo "</div>";
                  echo "</div>";
                    }
                  echo  "</div>";
